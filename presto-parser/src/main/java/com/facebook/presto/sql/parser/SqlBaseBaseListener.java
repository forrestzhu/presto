...
/**
 * This class provides an empty implementation of {@link SqlBaseListener}, which can be extended to create a listener
...
public class SqlBaseBaseListener implements SqlBaseListener
{
     ...
     */
    @Override
    public void enterTableProperties(SqlBaseParser.TablePropertiesContext ctx)
    {
    }
     ...
     */
    @Override
    public void exitTableProperties(SqlBaseParser.TablePropertiesContext ctx)
    {
    }
     ...
     */
    @Override
    public void enterBaseType(SqlBaseParser.BaseTypeContext ctx)
    {
    }
     ...
     */
    @Override
    public void exitBaseType(SqlBaseParser.BaseTypeContext ctx)
    {
    }
