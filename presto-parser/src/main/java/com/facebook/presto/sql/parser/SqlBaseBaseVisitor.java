...
/**
 * This class provides an empty implementation of {@link SqlBaseVisitor}, which can be extended to create a visitor
...
public class SqlBaseBaseVisitor<T> extends AbstractParseTreeVisitor<T> implements SqlBaseVisitor<T>
{
     ...
     */
    @Override
    public T visitTableProperties(SqlBaseParser.TablePropertiesContext ctx)
    {
        return visitChildren(ctx);
    }
     ...
     */
    @Override
    public T visitBaseType(SqlBaseParser.BaseTypeContext ctx)
    {
        return visitChildren(ctx);
    }
